...
class _MyAppState extends State<MyApp> {
  ...
  Widget _buildFloatingNavBar(ColorScheme colorScheme) {
    final shadowColor = _themeMode == ThemeMode.dark
        ? Colors.black.withValues(alpha: 0.8) //Valutare se usare una tonalità chiara glow up o ombra scura semplice
    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: MediaQuery.removePadding(
          context: context,
          removeBottom: true, //rimuove il padding perché già stabilito nello Stack
          child: SizedBox(
            height: 70,
    ...
    return MaterialApp(
      ...
      home: Builder(
        builder: (builderContext) => Scaffold(
          resizeToAvoidBottomInset: false, // evita il resize del body quando appare la tastiera
              ...
              children: [
                DrawerHeader(
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(Icons.menu_book, size: 40, color: currentColorScheme.onPrimaryContainer),
